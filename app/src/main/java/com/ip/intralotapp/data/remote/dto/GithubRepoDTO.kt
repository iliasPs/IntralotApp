...
/**
 * In this package there are Data Transfer objects where we handle according
 * to our app's needs. Ie mapping the models they way we need to use them
 */
...
fun GithubRepoDTO.toGitHubRepo(): GithubRepo {
    ...
    return GithubRepo(
        ...
        permissions = permissionsDTO?.toPermissions(),
        size = size,
        updatedAt = updatedAt,
        url = url,
        watchers = watchers,
